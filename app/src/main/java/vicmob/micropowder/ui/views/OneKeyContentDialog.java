...
/**
 * author: Twisted
 * created on: 2017/7/20 15:22
 * description:
 */

public class OneKeyContentDialog extends Dialog implements View.OnClickListener {
     ...
     * @param callback 按钮回调
     */
    public OneKeyContentDialog(Context context, Callback callback) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.but_content:
                ...
                PrefUtils.putString(context, "OneKeyDialogText", ContentDialogText);
                callback.Positive();
                break;
        }
    }
